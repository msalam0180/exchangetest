 ...
 * @endcode
 */
$settings['hash_salt'] = 'x8P0hHH4IGwcHu_KEeYEf6FhHzjJl3zY-nmmdyPuOyfZfisgTKL-ggUXCEfs9J7UAoafm2YmAg';
 ...
 */
$settings['file_public_path'] = 'files/exchange';
...
if (isset($_ENV['AH_SITE_ENVIRONMENT'])) {
  $settings['file_private_path'] = '/mnt/files/' . $_ENV['AH_SITE_GROUP'] . '.' . $_ENV['AH_SITE_ENVIRONMENT'] . '/' . $site_path . '/files-private/exchange';
}
else {
  $settings['file_private_path'] = 'files-private/exchange';
}
...
if (file_exists('/var/www/site-php')) {
  require('/var/www/site-php/insidergov/insidergov-settings.inc');
}
...
// Acquia Connector - Set machine name for acquia connector based on env
if (isset($_ENV['AH_SITE_ENVIRONMENT'])) {
  switch ($_ENV['AH_SITE_ENVIRONMENT']) {
    case 'dev':
      $config['acquia_connector.settings']['spi']['site_machine_name'] = '4f37a5d5_b679_4b04_83cb_cf97797d574d__insidergovdev__5e2b024cbf5b2';
      $config['acquia_connector.settings']['spi']['site_environment'] = 'dev';
      break;
    case 'test':
      $config['acquia_connector.settings']['spi']['site_machine_name'] = '4f37a5d5_b679_4b04_83cb_cf97797d574d__insidergovstg__5e2ef4eb2c97d';
      $config['acquia_connector.settings']['spi']['site_environment'] = 'stg';
      break;
    case 'prod':
      $config['acquia_connector.settings']['spi']['site_machine_name'] = '4f37a5d5_b679_4b04_83cb_cf97797d574d__insidergov__5c89844e5cfe6';
      $config['acquia_connector.settings']['spi']['site_environment'] = 'prod';
      break;
    default:
  }
} else {
 ...
 * - More information at config/README.txt
 */

// Acquia Cloud only envs.
if (is_dir('/var/www/site-php')) {
  $settings['config_vcs_directory'] = $settings['config_sync_directory'];
  if (isset($_ENV['AH_NON_PRODUCTION']) && $_ENV['AH_NON_PRODUCTION'] == 1) {
    $config['config_split.config_split.local']['status'] = FALSE;
    $config['config_split.config_split.acquia']['status'] = TRUE;
    $config['config_split.config_split.dev']['status'] = TRUE;
    $config['config_split.config_split.prod']['status'] = FALSE;
  } else if (isset($_ENV['AH_PRODUCTION']) && $_ENV['AH_PRODUCTION'] == 1) {
    $config['config_split.config_split.local']['status'] = FALSE;
    $config['config_split.config_split.acquia']['status'] = TRUE;
...
// All other envs. except Acquia Cloud.
else {
