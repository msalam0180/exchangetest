 ...
 * @endcode
 */
$settings['hash_salt'] = 'T5GAAx5w4Ffks6jlpQRZWpjT-bMNF71r3m8hE1vdYRoAxHPrqx6Q7BF9sRygU74OsmeMmhRh9A';
...
# Disable Akamai on DCM domains
$server = $_SERVER['SERVER_NAME'];
if (strtolower(substr($server, 0, 3) === 'dcm')) {
  $settings['omit_vary_cookie'] = TRUE;
}
...
if (isset($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR']) && file_exists($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/cld_prod_insidergov_dev_default.inc')) {
  require $_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/cld_prod_insidergov_dev_default.inc';
}
// </DDSETTINGS>
...
//
//  # Force common chainedfast bins to use database -- see drupal.org/node/2820580
...
$settings['config_sync_directory'] = 'sites/default/files/config_jq9fq3x7TQjSKwny7qVcsQV9MT4TRc4H9W9llISLPRTr_da5gQo9SsZdMipDDVC9wBLP6dqwyA/sync';
