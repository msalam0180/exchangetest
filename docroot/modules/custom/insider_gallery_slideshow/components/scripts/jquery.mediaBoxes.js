 ...
 * ====================================================================== */
     ...
     * ====================================================================== */
        ...
        function goAndFilterIsotope(filterValue, filterGroup){
            ...
            $container.isotope({ filter: combineFilters(filters) });
        }
     ...
     * ====================================================================== */
        ...
        function loadMore( boxesToLoad, ignoreFilter){
            ...
            $container.isotope( 'insert', $(newBoxes), function(){
                /* Fix Load More Button */
                finishLoading();
     ...
     * ====================================================================== */
        ...
        $(settings.sortContainer).find('*[data-sort-by]').on('click', function(e){
            ...
            $container.isotope({ sortBy: sortValue, sortAscending: getSortDirection($this) });
        ...
        $(settings.sortContainer).parents('.media-boxes-sort').find('.media-boxes-sort-order').on('click', function(e){
            ...
            $container.isotope({ sortAscending: getSortDirection(sort_by) });
        });
     ...
     * ====================================================================== */
        ...
        function startMagnificpopup(container, selector){
            ...
            container.magnificPopup({
                ...
                closeMarkup         : '<button title="%title%" class="mfp-close" aria-label="%title%">×</button>',
                titleSrc            : 'title',
        ...
        function trigger_popup(){
            if(settings.deepLinkingOnPopup){
                ...
                if(hash_value != ''){
                    ...
                    //CUSTOM HANDLING OF BACK BUTTON NAVIGATION TO CLOSE POPUP IF NO HASH
                    jQuery(".mfp-close-btn-in").trigger("click");
                }
            }
        }
        trigger_popup();
     ...
     * ====================================================================== */
        ...
        this.insert = function (content, callback) { // insert and load all content into the grid
            ...
            $container.isotope( 'insert', $(content), function(){
                callback();
                $container.isotope('layout');
            });
